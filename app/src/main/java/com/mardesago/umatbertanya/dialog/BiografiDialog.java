...
public class BiografiDialog extends BottomSheetDialog implements View.OnClickListener {
    ...
    public BiografiDialog(@NonNull Context context, int theme, biografi data) {
        super(context, theme);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide
                ...
                .load(StaticFunction.BASE_URL + "img/imam/" + data.getId_biografi() + ".jpg")
