...
public class DetailArtikelActivity extends AppCompatActivity {
    ...
    private List<biografi> imamList;
        ...
        WebViewClient webViewClient = new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
                ...
                if (url != null && url.toLowerCase().contains("immid")) {
                    ...
                    for (biografi imam : imamList) {
                        if (imam.getId_biografi() == Integer.valueOf(imams[1])) {
    ...
    private void showBiografiDialog(biografi data) {
    ...
    private void getData() {
        ...
        service.getDetail(idArtikel).enqueue(new Callback<artikel>() {
            ...
            public void onResponse(Call<artikel> call, Response<artikel> response) {
                ...
                recyclerMazhab.setLayoutManager(new LinearLayoutManager(DetailArtikelActivity.this));
    ...
    private void getImam() {
        ...
        service.getImam().enqueue(new Callback<List<biografi>>() {
            @Override
            public void onResponse(Call<List<biografi>> call, Response<List<biografi>> response) {
                imamList = response.body();
            }

            @Override
            public void onFailure(Call<List<biografi>> call, Throwable t) {
